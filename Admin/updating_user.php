...
while($get = mysqli_fetch_assoc( $get_record )){
    ...
    $new_first_name = $new_middle_name = $new_last_name = $new_gender = $new_preffix = $new_seven_digit = $new_email = "";
     $new_first_nameErr = $new_middle_nameErr = $new_last_namErr = $new_genderErr = $new_preffixErr = $new_seven_digitErr = $new_emailErr = "";
     ...
     if(isset($_POST["btnUpdate"])){
        ...
        if(empty($_POST["new_last_name"])){
            $new_last_namErr = "This field must not be empty!";
        }else{
        ...
        if(empty($_POST["new_seven_digit"])){
            ...
            $new_seven_digit = $new_seven_digit;
        }
...
<td> <input type="text" name="new_last_name" value="<?php echo $db_last_name; ?>"> <span class="error"><?php echo $new_last_namErr; ?> </span></td>
