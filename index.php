                        ...
                        if($count_last_name_string < 2) {
                            ...
                            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                ...
                                if($count_seven_digit_string < 7) {
                                    ...
                                    $seven_digitErr = "brad kulang ang seven digit number mo kapatid";

                                }else{

                                    function random_password ($length = 5 ){
                                        $str = "abcdefghijklmnopqrstuwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890";
       ...
       <table border="0" width="50%">
           ...
           <tr>
            <td>
                ...
                <input type="text" name="seven_digit" maxlength="7" placeholder="Other Seven Digit" onkeypress='return isNumberKey(event)' value="<?php echo $seven_digit; ?>"> <span class="error"><?php echo $seven_digitErr; ?></span>
